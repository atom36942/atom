...
async def func_client_read_kafka_producer(config_kafka_url: str, config_kafka_username: str = None, config_kafka_password: str = None) -> any:
...
async def func_client_read_kafka_consumer(config_kafka_url: str, config_kafka_username: str = None, config_kafka_password: str = None, channel_name: str = None, config_kafka_group_id: str = None, config_kafka_is_auto_commit: int = None) -> any:
