...
config_kafka_path_keyfile=config.get("config_kafka_path_keyfile")
...
config_postgres_min_connection=int(config.get("config_batch_object_create",5))
config_postgres_max_connection=int(config.get("config_batch_object_create",20))
