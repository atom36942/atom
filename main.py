...
"unique_1":"alter table users add constraint constraint_unique_users_username unique (username);",
"unique_2":"alter table report_user add constraint constraint_unique_report_user unique (created_by_id,user_id);",
