...
def logic_celery(channel=None):
    ...
    return func_consumer_celery_init(name, config_celery_broker_url, config_celery_backend_url, config_postgres_url, config_postgres_min_connection, config_postgres_max_connection, func_postgres_client_read, func_postgres_create, func_postgres_update, func_postgres_obj_serialize, task_registry, globals())
