...
### api docs
You can check all the generic apis atom provides by visiting below url:-
...
You can see the localhost api server at:-
...
Atom has a basic form to take user data using streamlit which can be further extended.
```
