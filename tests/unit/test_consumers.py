...
from core.script.consumer_postgres_create import execute as execute_create
from core.script.consumer_postgres_update import execute as execute_update
...
async def test_postgres_create_consumer_execute_calls_core_function():
    ...
    with patch("core.script.consumer_postgres_create.func_postgres_create", new_callable=AsyncMock) as mock_func_create:
...
async def test_postgres_update_consumer_execute_calls_core_function():
    ...
    with patch("core.script.consumer_postgres_update.func_postgres_update", new_callable=AsyncMock) as mock_func_update:
