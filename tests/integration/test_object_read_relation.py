...
async def test_object_read_relation_full_flow(integration_app):
    ...
    # Seed users
    u1_id = await pool.fetchval("INSERT INTO users (username, name, type) VALUES ('cre_1', 'Creator One', 1) RETURNING id")
    u2_id = await pool.fetchval("INSERT INTO users (username, name, type) VALUES ('cre_2', 'Creator Two', 1) RETURNING id")
