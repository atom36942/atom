...
async def func_api_my_object_create(*, request: Request):
    ...
    if oq["queue"]:
        payload = {"mode": oq["mode"], "table": oq["table"], "obj_list": obj_list, "is_serialize": oq["is_serialize"], "config_table": app_state.config_table, "config_obj_list_limit": app_state.config_obj_list_limit, "config_buffer_limit": app_state.config_table.get(oq["table"], {}).get("buffer", app_state.config_buffer_limit)}
        return {"status": 1, "message": await app_state.func_orchestrator_producer(queue=oq["queue"], func_name=app_state.func_postgres_create.__name__, payload=payload, client_celery_producer=app_state.client_celery_producer, client_kafka_producer=app_state.client_kafka_producer, client_rabbitmq_producer=app_state.client_rabbitmq_producer, client_redis_producer=app_state.client_redis_producer)}
...
async def func_api_my_object_update(*, request: Request):
    ...
    if oq["queue"]:
        payload = {"mode": oq["mode"], "table": oq["table"], "obj_list": obj_list, "is_serialize": oq["is_serialize"], "created_by_id": created_by_id, "config_table": app_state.config_table, "config_obj_list_limit": app_state.config_obj_list_limit, "config_buffer_limit": app_state.config_table.get(oq["table"], {}).get("buffer", app_state.config_buffer_limit)}
        return {"status": 1, "message": await app_state.func_orchestrator_producer(queue=oq["queue"], func_name=app_state.func_postgres_update.__name__, payload=payload, client_celery_producer=app_state.client_celery_producer, client_kafka_producer=app_state.client_kafka_producer, client_rabbitmq_producer=app_state.client_rabbitmq_producer, client_redis_producer=app_state.client_redis_producer)}
    return {"status": 1, "message": await app_state.func_postgres_update(client_postgres_pool=app_state.client_postgres_pool, client_password_hasher=app_state.client_password_hasher, func_postgres_serialize=app_state.func_postgres_serialize, func_regex_check=app_state.func_regex_check, cache_postgres_schema=app_state.cache_postgres_schema, config_regex=app_state.config_regex, config_table=app_state.config_table, config_obj_list_limit=app_state.config_obj_list_limit, config_buffer_limit=app_state.config_table.get(oq["table"], {}).get("buffer", app_state.config_buffer_limit), mode=oq["mode"], table=oq["table"], obj_list=obj_list, is_serialize=oq["is_serialize"], created_by_id=created_by_id, client_postgres_conn=None)}
