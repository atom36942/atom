...
async def func_api_public_otp_verify_email(*, request: Request):
    app_state = request.app.state
    oq = await app_state.func_request_param_read(request=request, mode="query", strict=0, config=[("otp", "int", 1, None, None, None, None), ("email", "str", 1, None, None, None, app_state.config_regex["email"])])
...
async def func_api_public_otp_verify_mobile(*, request: Request):
    app_state = request.app.state
    oq = await app_state.func_request_param_read(request=request, mode="query", strict=0, config=[("otp", "int", 1, None, None, None, None), ("mobile", "str", 1, None, None, None, app_state.config_regex["mobile"])])
...
async def func_api_public_otp_send_email_ses(*, request: Request):
    app_state = request.app.state
    od = await app_state.func_request_param_read(request=request, mode="query", strict=0, config=[("sender", "str", 1, None, None, None, None), ("email", "str", 1, None, None, None, app_state.config_regex["email"])])
...
async def func_api_public_otp_send_mobile_sns(*, request: Request):
    app_state = request.app.state
    od = await app_state.func_request_param_read(request=request, mode="query", strict=0, config=[("mobile", "str", 1, None, None, None, app_state.config_regex["mobile"])])
...
async def func_api_public_otp_send_mobile_sns_template(*, request: Request):
    app_state = request.app.state
    od = await app_state.func_request_param_read(request=request, mode="body", strict=0, config=[("mobile", "str", 1, None, None, None, app_state.config_regex["mobile"]), ("message", "str", 1, None, None, None, None), ("template_id", "str", 1, None, None, None, None), ("entity_id", "str", 1, None, None, None, None), ("sender_id", "str", 1, None, None, None, None)])
    otp = await app_state.func_otp_generate(client_postgres_pool=app_state.client_postgres_pool, mobile=od["mobile"], email=None)
...
async def func_api_public_jira_worklog_export(*, request: Request):
    app_state = request.app.state
    ob = await app_state.func_request_param_read(request=request, mode="body", strict=0, config=[("url", "str", 1, None, None, None, None), ("email", "str", 1, None, None, None, app_state.config_regex["email"]), ("api_token", "str", 1, None, None, None, None), ("start_date", "str", 1, None, None, None, None), ("end_date", "str", 1, None, None, None, None)])
