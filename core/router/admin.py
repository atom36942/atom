...
async def func_api_admin_object_create(*, request: Request):
    ...
    return await app_state.func_orchestrator_obj_create(user_id=None, api_role="admin", table=oq["table"], mode=oq["mode"], is_serialize=oq["is_serialize"], queue=oq["queue"], obj_list=obj_list, config_table_create_disable_my=app_state.config_table_create_disable_my, config_table_create_enable_public=app_state.config_table_create_enable_public, config_column_disable=app_state.config_column_disable, config_table=app_state.config_table, config_regex=app_state.config_regex, func_regex_check=app_state.func_regex_check, client_celery_producer=app_state.client_celery_producer, client_kafka_producer=app_state.client_kafka_producer, client_rabbitmq_producer=app_state.client_rabbitmq_producer, client_redis_producer=app_state.client_redis_producer, func_orchestrator_producer=app_state.func_orchestrator_producer, func_postgres_create=app_state.func_postgres_create, client_postgres_pool=app_state.client_postgres_pool, client_password_hasher=app_state.client_password_hasher, func_postgres_serialize=app_state.func_postgres_serialize, cache_postgres_schema=app_state.cache_postgres_schema, cache_postgres_buffer=app_state.cache_postgres_buffer, client_postgres_conn=None)
...
async def func_api_admin_ids_delete(*, request: Request):
    ...
    return await app_state.func_postgres_delete(client_postgres_pool=app_state.client_postgres_pool, table=oq["table"], ids=ob["ids"], created_by_id=None, client_postgres_conn=None)
...
async def func_api_admin_postgres_runner(*, request: Request):
    ...
    return await app_state.func_postgres_runner(client_postgres_pool=app_state.client_postgres_pool, mode=ob["mode"], query=ob["query"])
