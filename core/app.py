...
async def func_lifespan(app:"FastAPI"):
    try:
        ...
        #check
        app.state.func_check(app_routes=app.routes, config_config_path=app.state.config_config_path, config_function_path=app.state.config_function_path, config_api_namespace=app.state.config_api_namespace, config_router_path=app.state.config_router_path, config_api=app.state.config_api, config_allowed_user_storage_backends=app.state.config_allowed_user_storage_backends, config_allowed_api_storage_backends=app.state.config_allowed_api_storage_backends, config_postgres=app.state.config_postgres)
        #structure
        import os
...
async def middleware(request, api_function):
    ...
    try:
        ...
        await app_state.func_middleware_check_deactivated(user_dict=request.state.user, url_path=request.url.path, config_api=app_state.config_api, client_postgres_pool=app_state.client_postgres_pool, client_redis=app_state.client_redis, cache_users_deactivated=app_state.cache_users_deactivated, config_redis_cache_ttl_sec=app_state.config_redis_cache_ttl_sec)
        await app_state.func_middleware_check_deleted(user_dict=request.state.user, url_path=request.url.path, config_api=app_state.config_api, client_postgres_pool=app_state.client_postgres_pool, client_redis=app_state.client_redis, cache_users_deleted=app_state.cache_users_deleted, config_redis_cache_ttl_sec=app_state.config_redis_cache_ttl_sec)
