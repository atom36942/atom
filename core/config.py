...
"idx_report_test_deactivated_at_not_null": "CREATE INDEX IF NOT EXISTS idx_report_test_deactivated_at_not_null ON report_test (id) WHERE deactivated_at IS NOT NULL",
...
"idx_comment_test_deactivated_at_not_null": "CREATE INDEX IF NOT EXISTS idx_comment_test_deactivated_at_not_null ON comment_test (id) WHERE deactivated_at IS NOT NULL",
"idx_comment_candidate_deleted_at_not_null": "CREATE INDEX IF NOT EXISTS idx_comment_candidate_deleted_at_not_null ON comment_candidate (id) WHERE deleted_at IS NOT NULL",
"idx_comment_candidate_deactivated_at_not_null": "CREATE INDEX IF NOT EXISTS idx_comment_candidate_deactivated_at_not_null ON comment_candidate (id) WHERE deactivated_at IS NOT NULL",
"idx_feedback_test_deleted_at_not_null": "CREATE INDEX IF NOT EXISTS idx_feedback_test_deleted_at_not_null ON feedback_test (id) WHERE deleted_at IS NOT NULL",
"idx_feedback_test_deactivated_at_not_null": "CREATE INDEX IF NOT EXISTS idx_feedback_test_deactivated_at_not_null ON feedback_test (id) WHERE deactivated_at IS NOT NULL",
