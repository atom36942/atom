...
{"name":"is_active","datatype":"smallint","default":1,"in":(0,1),"index":"btree(is_active)"},
...
{"name":"is_read","datatype":"smallint","default":0,"index":"btree(is_read)"}
],
"report_test":[
{"name":"created_at","datatype":"timestamptz","default":"now()"},
{"name":"is_deleted","datatype":"smallint","default":0,"in":(0,1),"index":"btree(is_deleted)"},
...
{"name":"quantity","datatype":"bigint","is_mandatory":1},
