...
{"name":"is_active","datatype":"smallint","in":(0,1),"index":"is_active(btree)"},
{"name":"is_verified","datatype":"smallint","in":(0,1),"index":"is_verified(btree)"},
{"name":"is_deleted","datatype":"smallint","in":(0,1),"index":"is_deleted(btree)"},
{"name":"is_protected","datatype":"smallint","in":(0,1),"index":"is_protected(btree)"},
{"name":"type","datatype":"smallint","index":"type(btree)"},
...
{"name":"status","datatype":"smallint","old":"status2","index":"status,type(btree)"},
...
{"name":"is_deleted","datatype":"smallint","in":(0,1),"index":"is_deleted(btree)"},
{"name":"is_protected","datatype":"smallint","in":(0,1),"index":"is_protected(btree)"},
{"name":"type","datatype":"smallint","is_mandatory":1,"index":"type(btree)"},
...
{"name":"status_code","datatype":"smallint","index":"status_code(btree)"},
...
{"name":"is_read","datatype":"smallint","index":"is_read(btree)"}
],
"report_test":[
{"name":"created_at","datatype":"timestamptz","default":"now()"},
{"name":"is_deleted","datatype":"smallint","in":(0,1),"index":"is_deleted(btree)"},
...
{"name":"updated_by_id","datatype":"bigint"},
{"name":"description","datatype":"text","is_mandatory":1},
{"name":"status","datatype":"smallint","index":"status(btree)"},
