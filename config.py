...
"/info": {"id": 17, "is_token_check": 0, "api_cache_sec": ["inmemory", 300, 0]},
...
"/public/table-groupby": {"id": 18, "is_token_check": 0, "api_cache_sec": ["inmemory", 10, 0]},
"/public/table-distinct": {"id": 96, "is_token_check": 0, "api_cache_sec": ["inmemory", 10, 0]},
# admin
"/admin/sync": {"id": 1, "is_token_check": 1, "user_check_role": ["realtime", [1]]},
"/admin/object-create": {"id": 2, "is_token_check": 1, "user_check_role": ["token", [1]]},
"/admin/object-update": {"id": 3, "is_token_check": 1, "user_check_role": ["token", [1]]},
"/admin/object-read": {"id": 4, "is_token_check": 1, "user_check_role": ["token", [1, 2]]},
"/admin/object-delete": {"id": 5, "is_token_check": 1, "user_check_role": ["realtime", [1]], "user_check_deactivated": ["realtime"], "user_check_deleted": ["realtime"], "api_ratelimiting_times_sec": ["inmemory", 10, 60]},
"/admin/postgres-import": {"id": 8, "is_token_check": 1, "user_check_role": ["realtime", [1]]},
"/admin/redis-import": {"id": 9, "is_token_check": 1, "user_check_role": ["token", [1]]},
"/admin/mongodb-import": {"id": 11, "is_token_check": 1, "user_check_role": ["token", [1]]},
"/admin/blob-container-read": {"id": 10, "is_token_check": 1, "user_check_role": ["inmemory", [1]]},
"/admin/blob-container-ops": {"id": 12, "is_token_check": 1, "user_check_role": ["token", [1]]},
"/admin/blob-delete-url": {"id": 13, "is_token_check": 1, "user_check_role": ["token", [1]]},
"/admin/postgres-info": {"id": 84, "is_token_check": 1, "user_check_role": ["token", [1, 2]], "api_cache_sec": ["inmemory", 300, 0]},
"/admin/postgres-schema": {"id": 85, "is_token_check": 1, "user_check_role": ["token", [1, 2]], "api_cache_sec": ["inmemory", 300, 0]},
"/admin/postgres-query-runner-write": {"id": 6, "is_token_check": 1, "user_check_role": ["realtime", [1]]},
"/admin/postgres-query-runner-read": {"id": 22, "is_token_check": 1, "user_check_role": ["token", [1, 2]]},
"/admin/postgres-query-runner-read-export": {"id": 7, "is_token_check": 1, "user_check_role": ["inmemory", [1, 2]]},
"/admin/postgres-query-generator-ai": {"id": 90, "is_token_check": 1, "user_check_role": ["token", [1, 2]]},
"/admin/mssql-query-runner-write": {"id": 21, "is_token_check": 1, "user_check_role": ["realtime", [1]]},
"/admin/mssql-query-runner-read": {"id": 23, "is_token_check": 1, "user_check_role": ["token", [1,2]]},
"/admin/mssql-query-runner-read-export": {"id": 89, "is_token_check": 1, "user_check_role": ["realtime", [1,2]]},
"/admin/clickhouse-query-runner-write": {"id": 93, "is_token_check": 1, "user_check_role": ["realtime", [1]], "user_check_deactivated": ["realtime"], "user_check_deleted": ["realtime"]},
"/admin/clickhouse-query-runner-read": {"id": 94, "is_token_check": 1, "user_check_role": ["token", [1,2]]},
"/admin/clickhouse-query-runner-read-export": {"id": 95, "is_token_check": 1, "user_check_role": ["inmemory", [1,2]]},
}
