...
"/admin/object-update": {"id": 3, "is_token": True, "user_check_role": {"mode": "token", "roles": [1, 4]}},
"/admin/object-read": {"id": 4, "is_token": True, "user_check_role": {"mode": "token", "roles": [1, 2, 4]}},
"/admin/table-column-groupby": {"id": 104, "is_token": True, "user_check_role": {"mode": "token", "roles": [1, 2, 4]}, "cache": {"mode": "inmemory", "ttl_sec": 10, "is_per_user": False}},
...
"/admin/object-delete": {"id": 5, "is_token": True, "user_check_role": {"mode": "realtime", "roles": [1, 4]}, "user_check_deactivated": {"mode": "realtime"}, "user_check_deleted": {"mode": "realtime"}, "rate_limit": {"mode": "inmemory", "limit": 10, "window_sec": 60}},
