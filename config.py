...
# myshipment
"/myshipment/buyer-360": {"id": 32, "is_token": 1, "user_check_role": ["token", [1, 2]], "api_cache_sec": ["redis", 600]},
"/myshipment/my-profile": {"id": 24, "is_token": 1, "user_check_role": ["token", [3]], "api_cache_sec": ["redis", 600, 1]},
"/myshipment/my-purchase-orders": {"id": 25, "is_token": 1, "user_check_role": ["token", [3]], "api_cache_sec": ["redis", 300, 1]},
"/myshipment/my-purchase-orders-line-items": {"id": 33, "is_token": 1, "user_check_role": ["token", [3]], "api_cache_sec": ["redis", 300, 1]},
"/myshipment/my-shipments": {"id": 26, "is_token": 1, "user_check_role": ["token", [3]], "api_cache_sec": ["redis", 300, 1]},
"/myshipment/my-containers": {"id": 27, "is_token": 1, "user_check_role": ["token", [3]], "api_cache_sec": ["redis", 300, 1]},
"/myshipment/my-tracking": {"id": 28, "is_token": 1, "user_check_role": ["token", [3]], "api_cache_sec": ["redis", 300, 1]},
"/myshipment/my-alerts": {"id": 29, "is_token": 1, "user_check_role": ["token", [3]], "api_cache_sec": ["redis", 300, 1]},
"/myshipment/my-documents": {"id": 30, "is_token": 1, "user_check_role": ["token", [3]], "api_cache_sec": ["redis", 300, 1]},
"/myshipment/my-documents-download": {"id": 34, "is_token": 1, "user_check_role": ["token", [3]]},
"/myshipment/my-analytics": {"id": 31, "is_token": 1, "user_check_role": ["token", [3]], "api_cache_sec": ["redis", 600, 1]},
# quotation
