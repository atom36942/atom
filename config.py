...
# myshipment
"/myshipment/my-account": {"id": 24, "is_token": 1, "user_check_role": ["token", [1, 2]], "api_cache_sec": ["inmemory", 600, 1]},
"/myshipment/my-purchase-orders": {"id": 25, "is_token": 1, "user_check_role": ["token", [1, 2]], "api_cache_sec": ["inmemory", 300, 1]},
"/myshipment/my-purchase-orders-line-items": {"id": 33, "is_token": 1, "user_check_role": ["token", [1, 2]], "api_cache_sec": ["inmemory", 300, 1]},
"/myshipment/my-cache": {"id": 91, "is_token": 1, "user_check_role": ["token", [1, 2]], "api_cache_sec": ["inmemory", 14400, 1]},
"/myshipment/my-shipments": {"id": 26, "is_token": 1, "user_check_role": ["token", [1, 2]], "api_cache_sec": ["inmemory", 300, 1]},
"/myshipment/my-containers": {"id": 27, "is_token": 1, "user_check_role": ["token", [1, 2]], "api_cache_sec": ["inmemory", 300, 1]},
"/myshipment/my-tracking": {"id": 28, "is_token": 1, "user_check_role": ["token", [1, 2]], "api_cache_sec": ["inmemory", 300, 1]},
"/myshipment/my-alerts": {"id": 29, "is_token": 1, "user_check_role": ["token", [1, 2]], "api_cache_sec": ["inmemory", 300, 1]},
"/myshipment/my-documents": {"id": 30, "is_token": 1, "user_check_role": ["token", [1, 2]], "api_cache_sec": ["inmemory", 300, 1]},
"/myshipment/my-documents-download": {"id": 34, "is_token": 1, "user_check_role": ["token", [1, 2]]},
"/myshipment/my-analytics": {"id": 31, "is_token": 1, "user_check_role": ["token", [1, 2]], "api_cache_sec": ["inmemory", 600, 1]},
"/myshipment/buyer-360": {"id": 32, "is_token": 1, "user_check_role": ["token", [1, 2]], "api_cache_sec": ["inmemory", 600]},
# quotation
...
"/quotation/my-rate-delete": {"id": 75, "is_token": 1, "user_check_role": ["token", [1, 2]]},
"/quotation/rate-read": {"id": 72, "is_token": 1, "user_check_role": ["token", [1, 2, 3]]},
"/quotation/my-create": {"id": 78, "is_token": 1, "user_check_role": ["token", [1, 3]]},
"/quotation/my-update": {"id": 79, "is_token": 1, "user_check_role": ["token", [1, 3]]},
"/quotation/my-delete": {"id": 82, "is_token": 1, "user_check_role": ["token", [1, 3]]},
"/quotation/my-read": {"id": 83, "is_token": 1, "user_check_role": ["token", [1, 3]]},
"/quotation/decision": {"id": 80, "is_token": 1, "user_check_role": ["token", [1, 2]]},
"/quotation/read": {"id": 81, "is_token": 1, "user_check_role": ["token", [1, 2]]},
}
...
{"name":"username","datatype":"text","is_mandatory":1,"unique":"username,type","index":"gin_trgm(username)"},
...
{"name":"code","datatype":"text","index":"btree(code)"},
