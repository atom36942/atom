...
async def func_api_public_converter_number(*, request:Request):
   ...
   obj_query=await st.func_request_param_read(request=request, mode="query", config=[("datatype","str",1,["smallint","int","bigint"],None,None,None),("mode","str",1,["encode","decode"],None,None,None),("x","str",1,None,None,None,None)], strict=0)
...
async def func_api_public_jira_worklog_export(*, request:Request):
   st=request.app.state
   obj_body=await st.func_request_param_read(request=request, mode="body", config=[("url","str",1,None,None,None,None),("email","str",1,None,None,None,None),("api_token","str",1,None,None,None,None),("start_date","str",1,None,None,None,None),("end_date","str",1,None,None,None,None)], strict=0)
   import asyncio, uuid
