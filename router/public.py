...
async def function_api_public_otp_verify(request:Request):
   param=await function_request_param_read(request,"query",[["otp","int",1,None],["email",None,0,None],["mobile",None,0,None]])
...
async def function_api_public_otp_send_email_ses(request:Request):
   param=await function_request_param_read(request,"query",[["sender",None,1,None],["email",None,1,None]])
...
async def function_api_public_otp_send_mobile_sns(request:Request):
   param=await function_request_param_read(request,"query",[["mobile",None,1,None]])
...
async def function_api_public_otp_send_mobile_sns_template(request:Request):
   param=await function_request_param_read(request,"body",[["mobile",None,1,None],["message",None,1,None],["template_id",None,1,None],["entity_id",None,1,None],["sender_id",None,1,None]])
   otp=await function_otp_generate(request.app.state.client_postgres_pool,None,param["mobile"])
...
async def function_api_public_object_read_gsheet(request:Request):
   param=await function_request_param_read(request,"query",[["url",None,1,None]])
...
async def function_api_public_jira_worklog_export(request:Request):
   param=await function_request_param_read(request,"body",[["jira_base_url",None,1,None],["jira_email",None,1,None],["jira_token",None,1,None],["start_date",None,0,None],["end_date",None,0,None]])
...
async def function_api_public_converter_integer(request:Request):
   param=await function_request_param_read(request,"query",[["mode",None,1,None],["x",None,1,None],["max_length","int",0,None]])
