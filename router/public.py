...
async def func_api_public_converter_number(*, request: Request):
    ...
    oq = await app_state.func_request_param_read(request=request, mode="query", config=[("datatype", "str", 1, ["smallint", "int", "bigint"], None, None, None), ("mode", "str", 1, ["encode", "decode"], None, None, None), ("x", "str", 1, None, None, None, None)], strict=0)
...
async def func_api_public_otp_verify_email(*, request: Request):
    app_state = request.app.state
    oq = await app_state.func_request_param_read(request=request, mode="query", config=[("otp", "int", 1, None, None, None, None), ("email", "str", 1, None, None, None, None)], strict=0)
...
async def func_api_public_otp_verify_mobile(*, request: Request):
    app_state = request.app.state
    oq = await app_state.func_request_param_read(request=request, mode="query", config=[("otp", "int", 1, None, None, None, None), ("mobile", "str", 1, None, None, None, None)], strict=0)
...
async def func_api_public_otp_send_email_ses(*, request: Request):
    app_state = request.app.state
    od = await app_state.func_request_param_read(request=request, mode="query", config=[("sender", "str", 1, None, None, None, None), ("email", "str", 1, None, None, None, None)], strict=0)
...
async def func_api_public_otp_send_mobile_sns(*, request: Request):
    app_state = request.app.state
    od = await app_state.func_request_param_read(request=request, mode="query", config=[("mobile", "str", 1, None, None, None, None)], strict=0)
...
async def func_api_public_otp_send_mobile_sns_template(*, request: Request):
    app_state = request.app.state
    od = await app_state.func_request_param_read(request=request, mode="body", config=[("mobile", "str", 1, None, None, None, None), ("message", "str", 1, None, None, None, None), ("template_id", "str", 1, None, None, None, None), ("entity_id", "str", 1, None, None, None, None), ("sender_id", "str", 1, None, None, None, None)], strict=0)
    otp = await app_state.func_otp_generate(client_postgres_pool=app_state.client_postgres_pool, mobile=od["mobile"], email=None)
...
async def func_api_public_jira_worklog_export(*, request: Request):
    app_state = request.app.state
    ob = await app_state.func_request_param_read(request=request, mode="body", config=[("url", "str", 1, None, None, None, None), ("email", "str", 1, None, None, None, None), ("api_token", "str", 1, None, None, None, None), ("start_date", "str", 1, None, None, None, None), ("end_date", "str", 1, None, None, None, None)], strict=0)
...
async def func_api_public_table_tag_read(*, request: Request):
    app_state = request.app.state
    oq = await app_state.func_request_param_read(request=request, mode="query", config=[("table", "str", 1, app_state.cache_postgres_schema_tables, None, None, None), ("column", "str", 1, app_state.cache_postgres_schema_columns, None, None, None), ("limit", "int", 0, None, 100, None, None), ("page", "int", 0, None, 1, None, None), ("filter_column", "str", 0, app_state.cache_postgres_schema_columns, None, None, None), ("filter_value", "str", 0, None, None, None, None)], strict=0)
