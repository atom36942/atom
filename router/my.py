...
async def func_api_my_api_usage(*, request:Request):
   st=request.app.state
   obj_query=await st.func_request_param_read(request_obj=request, parsing_mode="query", param_config=[("days","int",1,None,None,None,None)], is_strict=0)
...
async def func_api_my_account_delete(*, request:Request):
   st=request.app.state
   obj_query=await st.func_request_param_read(request_obj=request, parsing_mode="query", param_config=[("mode","str",1,["soft","hard"],None,None,None)], is_strict=0)
...
async def func_api_my_message_received(*, request:Request):
   st=request.app.state
   obj_query=await st.func_request_param_read(request_obj=request, parsing_mode="query", param_config=[("mode","str",1,["all","unread","read"],None,None,None),("order","str",0,None,"id desc",None,None),("limit","int",0,None,100,None,None),("page","int",0,None,1,None,None)], is_strict=0)
...
async def func_api_my_message_thread(*, request:Request):
   st=request.app.state
   obj_query=await st.func_request_param_read(request_obj=request, parsing_mode="query", param_config=[("user_id","int",1,None,None,None,None),("order","str",0,None,"id desc",None,None),("limit","int",0,None,100,None,None),("page","int",0,None,1,None,None)], is_strict=0)
   # RENAMED: sort_order -> order, limit_count -> limit, page_number -> page
   obj_list=await st.func_message_thread(client_postgres_pool=st.client_postgres_pool, user_one_id=request.state.user["id"], user_two_id=obj_query["user_id"], order=obj_query["order"], limit=obj_query["limit"], page=obj_query["page"])
...
async def func_api_my_message_delete_single(*, request:Request):
   st=request.app.state
   obj_query=await st.func_request_param_read(request_obj=request, parsing_mode="query", param_config=[("id","int",1,None,None,None,None)], is_strict=0)
...
async def func_api_my_message_delete_bulk(*, request:Request):
   st=request.app.state
   obj_query=await st.func_request_param_read(request_obj=request, parsing_mode="query", param_config=[("mode","str",1,["sent","received","all"],None,None,None)], is_strict=0)
   # RENAMED: delete_mode -> mode
...
async def func_api_my_object_create_mongodb(*, request:Request):
   st=request.app.state
   obj_query=await st.func_request_param_read(request_obj=request, parsing_mode="query", param_config=[("database","str",1,None,None,None,None),("table","str",1,None,None,None,None)], is_strict=0)
   obj_body=await st.func_request_param_read(request_obj=request, parsing_mode="body", param_config=[], is_strict=0)
