...
async def func_api_my_api_usage(*, request:Request):
   st=request.app.state
   obj_query=await st.func_request_param_read(request=request, mode="query", config=[("days","int",1,None,None,None,None,None)], strict=0)
...
async def func_api_my_account_delete(*, request:Request):
   st=request.app.state
   obj_query=await st.func_request_param_read(request=request, mode="query", config=[("mode","str",1,["soft","hard"],None,None,None,None)], strict=0)
...
async def func_api_my_message_received(*, request:Request):
   st=request.app.state
   obj_query=await st.func_request_param_read(request=request, mode="query", config=[("mode","str",1,["all","unread","read"],None,None,None,None),("order","str",0,None,"id desc",None,None,None),("limit","int",0,None,100,None,None,None),("page","int",0,None,1,None,None,None)], strict=0)
...
async def func_api_my_message_thread(*, request:Request):
   st=request.app.state
   obj_query=await st.func_request_param_read(request=request, mode="query", config=[("user_id","int",1,None,None,None,None,None),("order","str",0,None,"id desc",None,None,None),("limit","int",0,None,100,None,None,None),("page","int",0,None,1,None,None,None)], strict=0)
   # RENAMED: sort_order -> order, limit_count -> limit, page_number -> page
...
async def func_api_my_message_delete_single(*, request:Request):
   st=request.app.state
   obj_query=await st.func_request_param_read(request=request, mode="query", config=[("id","int",1,None,None,None,None,None)], strict=0)
...
async def func_api_my_message_delete_bulk(*, request:Request):
   st=request.app.state
   obj_query=await st.func_request_param_read(request=request, mode="query", config=[("mode","str",1,["sent","received","all"],None,None,None,None)], strict=0)
   # RENAMED: delete_mode -> mode
...
async def func_api_my_parent_read(*, request:Request):
   st=request.app.state
   obj_query=await st.func_request_param_read(request=request, mode="query", config=[("table","str",1,st.cache_postgres_schema_tables,None,None,None,None),("parent_table","str",1,st.cache_postgres_schema_tables,None,None,None,None),("parent_column","str",1,st.cache_postgres_schema_columns,None,None,None,None),("order","str",0,None,"id desc",None,None,None),("limit","int",0,None,100,None,None,None),("page","int",0,None,1,None,None,None)], strict=0)
...
async def func_api_my_object_create_mongodb(*, request:Request):
   st=request.app.state
   obj_query=await st.func_request_param_read(request=request, mode="query", config=[("database","str",1,None,None,None,None,None),("table","str",1,None,None,None,None,None)], strict=0)
   obj_body=await st.func_request_param_read(request=request, mode="body", config=[], strict=0)
