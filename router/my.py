...
async def func_api_my_profile(*, request: Request):
    ...
    profile = await app_state.func_user_profile_read(client_postgres_pool=app_state.client_postgres_pool, user_id=request.state.user["id"], config_sql=app_state.config_sql)
...
async def func_api_my_api_usage(*, request: Request):
    app_state = request.app.state
    obj_query = await app_state.func_request_param_read(request=request, mode="query", config=[("days", "int", 1, None, None, None, None)], strict=0)
...
async def func_api_my_account_delete(*, request: Request):
    app_state = request.app.state
    obj_query = await app_state.func_request_param_read(request=request, mode="query", config=[("mode", "str", 1, ["soft", "hard"], None, None, None)], strict=0)
...
async def func_api_my_message_received(*, request: Request):
    app_state = request.app.state
    obj_query = await app_state.func_request_param_read(request=request, mode="query", config=[("mode", "str", 1, ["all", "unread", "read"], None, None, None), ("order", "str", 0, None, "id desc", None, None), ("limit", "int", 0, None, 100, None, None), ("page", "int", 0, None, 1, None, None)], strict=0)
...
async def func_api_my_message_thread(*, request: Request):
    app_state = request.app.state
    obj_query = await app_state.func_request_param_read(request=request, mode="query", config=[("user_id", "int", 1, None, None, None, None), ("order", "str", 0, None, "id desc", None, None), ("limit", "int", 0, None, 100, None, None), ("page", "int", 0, None, 1, None, None)], strict=0)
...
async def func_api_my_message_delete_single(*, request: Request):
    app_state = request.app.state
    obj_query = await app_state.func_request_param_read(request=request, mode="query", config=[("id", "int", 1, None, None, None, None)], strict=0)
...
async def func_api_my_message_delete_bulk(*, request: Request):
    app_state = request.app.state
    obj_query = await app_state.func_request_param_read(request=request, mode="query", config=[("mode", "str", 1, ["sent", "received", "all"], None, None, None)], strict=0)
...
async def func_api_my_parent_read(*, request: Request):
    app_state = request.app.state
    obj_query = await app_state.func_request_param_read(request=request, mode="query", config=[("table", "str", 1, app_state.cache_postgres_schema_tables, None, None, None), ("parent_table", "str", 1, app_state.cache_postgres_schema_tables, None, None, None), ("parent_column", "str", 1, app_state.cache_postgres_schema_columns, None, None, None), ("order", "str", 0, None, "id desc", None, None), ("limit", "int", 0, None, 100, None, None), ("page", "int", 0, None, 1, None, None)], strict=0)
...
async def func_api_my_ids_delete(*, request: Request):
    app_state = request.app.state
    obj_body = await app_state.func_request_param_read(request=request, mode="body", config=[("table", "str", 1, app_state.cache_postgres_schema_tables, None, None, None), ("ids", "str", 1, None, None, None, None)], strict=0)
    output = await app_state.func_postgres_delete(client_postgres_pool=app_state.client_postgres_pool, table=obj_body["table"], ids=obj_body["ids"], created_by_id=request.state.user.get("id", 0), config_postgres_ids_delete_limit=app_state.config_postgres_ids_delete_limit)
    return {"status": 1, "message": output}
...
async def func_api_my_object_create_mongodb(*, request: Request):
    app_state = request.app.state
    obj_query = await app_state.func_request_param_read(request=request, mode="query", config=[("database", "str", 1, None, None, None, None), ("table", "str", 1, None, None, None, None)], strict=0)
    obj_body = await app_state.func_request_param_read(request=request, mode="body", config=[], strict=0)
