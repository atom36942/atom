...
async def function_api_my_account_delete(request:Request):
   param=await function_request_param_read(request,"query",[["mode",None,1,None]])
   user=await function_user_read_single(request.app.state.client_postgres_pool,request.state.user["id"])
...
async def function_api_my_message_received(request:Request):
   param=await function_request_param_read(request,"query",[["is_unread","int",0,None],["order",None,0,"id desc"],["limit","int",0,100],["page","int",0,1]])
...
async def function_api_my_message_thread(request:Request):
   param=await function_request_param_read(request,"query",[["user_id","int",1,None],["order",None,0,"id desc"],["limit","int",0,100],["page","int",0,1]])
...
async def function_api_my_parent_read(request:Request):
   param=await function_request_param_read(request,"query",[["table",None,1,None],["parent_table",None,1,None],["parent_column",None,1,None],["order",None,0,"id desc"],["limit","int",0,100],["page","int",0,1]])
...
async def function_api_my_object_create_mongodb(request:Request):
   param=await function_request_param_read(request,"query",[["database",None,1,None],["table",None,1,None]])
...
async def function_api_my_object_update(request:Request):
   param=await function_request_param_read(request,"query",[["table",None,1,None],["is_serialize","int",0,0],["otp","int",0,0]])
   obj=await function_request_param_read(request,"body",[])
   obj_list=obj["object_list"] if "object_list" in obj else [obj]
   for i,x in enumerate(obj_list):
