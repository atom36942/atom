...
async def func_api_private_send_email(*, request: Request):
    ...
    ob = await app_state.func_request_param_read(request=request, mode="body", param_specs=[{"name": "service", "type": "str", "required": True, "allowed": app_state.config_email_services, "default": None}, {"name": "sender", "type": "str", "required": True, "allowed": None, "default": None}, {"name": "to", "type": "list", "required": True, "allowed": None, "default": None}, {"name": "subject", "type": "str", "required": True, "allowed": None, "default": None}, {"name": "text", "type": "str", "required": True, "allowed": None, "default": None}, {"name": "cc", "type": "list", "required": False, "allowed": None, "default": []}, {"name": "bcc", "type": "list", "required": False, "allowed": None, "default": []}, {"name": "reply_to", "type": "list", "required": False, "allowed": None, "default": []}])
...
async def func_api_private_users_list(*, request: Request):
    app_state = request.app.state
    oq = await app_state.func_request_param_read(request=request, mode="query", param_specs=[{"name": "db", "type": "str", "required": False, "allowed": None, "default": None}, {"name": "limit", "type": "int", "required": False, "allowed": None, "default": app_state.config_sql_read_limit_default}, {"name": "page", "type": "int", "required": False, "allowed": None, "default": 1}])
    client_postgres, cache_postgres_schema, cache_postgres_schema_ai = app_state.func_postgres_db_select(app_state=app_state, db=oq["db"])
