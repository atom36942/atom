...
async def func_api_private_s3_upload_file(request:Request):
   param=await func_request_obj_read(request,"form",[["bucket","str",1,None],["file","file",1,[]],["key","list",0,[]]])
   output={}
...
async def func_api_private_s3_upload_presigned(request:Request):
   param=await func_request_obj_read(request,"query",[["bucket","str",1,None],["key","str",0,None]])
