...
async def func_api_private_send_email(request:Request):
    ...
    ob = await app_state.func_request_param_read(request=request, mode="body", strict=0, param_specs=[{"name": "service", "type": "str", "required": 1, "allowed": app_state.config_email_services, "default": None}, {"name": "sender", "type": "str", "required": 1, "allowed": None, "default": None}, {"name": "to", "type": "list", "required": 1, "allowed": None, "default": None}, {"name": "subject", "type": "str", "required": 1, "allowed": None, "default": None}, {"name": "text", "type": "str", "required": 1, "allowed": None, "default": None}, {"name": "cc", "type": "list", "required": 0, "allowed": None, "default": []}, {"name": "bcc", "type": "list", "required": 0, "allowed": None, "default": []}, {"name": "reply_to", "type": "list", "required": 0, "allowed": None, "default": []}])
...
async def func_api_private_blob_container_sas(request:Request):
    app_state = request.app.state
    oq = await app_state.func_request_param_read(request=request, mode="query", strict=0, param_specs=[{"name": "service", "type": "str", "required": 1, "allowed": app_state.config_blob_services, "default": None}, {"name": "container", "type": "str", "required": 1, "allowed": None, "default": None}])
    if oq["service"] == "s3":
...
async def func_api_private_blob_preview_urls(request:Request):
    app_state = request.app.state
    of = await app_state.func_request_param_read(request=request, mode="body", strict=0, param_specs=[{"name": "service", "type": "str", "required": 1, "allowed": app_state.config_blob_services, "default": None}, {"name": "urls", "type": "list", "required": 1, "allowed": None, "default": None}])
