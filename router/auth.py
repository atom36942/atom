...
async def function_api_auth_signup_username_password(request:Request):
    ...
    param=await function_request_param_read(request,"body",[["type","int",1,None],["username",None,1,None],["password",None,1,None]])
...
async def function_api_auth_signup_username_password_bigint(request:Request):
    if config_is_signup==0:raise Exception("signup disabled")
    param=await function_request_param_read(request,"body",[["type","int",1,None],["username_bigint","int",1,None],["password_bigint","int",1,None]])
    if param["type"] not in config_auth_type_list:raise Exception("type not allowed")
...
async def function_api_auth_login_password_username(request:Request):
    param=await function_request_param_read(request,"body",[["type","int",1,None],["password",None,1,None],["username",None,1,None]])
...
async def function_api_auth_login_password_username_bigint(request:Request):
    param=await function_request_param_read(request,"body",[["type","int",1,None],["password_bigint","int",1,None],["username_bigint","int",1,None]])
...
async def function_api_auth_login_password_email(request:Request):
    param=await function_request_param_read(request,"body",[["type","int",1,None],["password",None,1,None],["email",None,1,None]])
...
async def function_api_auth_login_password_mobile(request:Request):
    param=await function_request_param_read(request,"body",[["type","int",1,None],["password",None,1,None],["mobile",None,1,None]])
...
async def function_api_auth_login_otp_email(request:Request):
    param=await function_request_param_read(request,"body",[["type","int",1,None],["otp","int",1,None],["email",None,1,None]])
    if param["type"] not in config_auth_type_list:raise Exception("type not allowed")
...
async def function_api_auth_login_otp_mobile(request:Request):
    param=await function_request_param_read(request,"body",[["type","int",1,None],["otp","int",1,None],["mobile",None,1,None]])
    if param["type"] not in config_auth_type_list:raise Exception("type not allowed")
...
async def function_api_auth_login_google(request:Request):
    param=await function_request_param_read(request,"body",[["type","int",1,None],["google_token",None,1,None]])
    if param["type"] not in config_auth_type_list:raise Exception("type not allowed")
