...
async def func_api_auth_signup_username_password(*, request:Request):
   ...
   obj_body=await app_state.func_request_param_read(request=request, mode="body", config=[("type","int",1,app_state.config_auth_type,None,None,"Enter Login Type, Example: 1, 2, 3"),("username","str",1,None,None,None,None),("password","str",1,None,None,["^\\S{8,32}$", "Password must be 8-32 characters and contain no spaces"],None)], strict=0)
...
async def func_api_auth_signup_username_password_bigint(*, request:Request):
   app_state=request.app.state
   obj_body=await app_state.func_request_param_read(request=request, mode="body", config=[("type","int",1,app_state.config_auth_type,None,None,"Enter Login Type, Example: 1, 2, 3"),("username_bigint","int",1,None,None,None,None),("password_bigint","int",1,None,None,["^[0-9]{6,12}$", "Password must be 6-12 digits"],None)], strict=0)
...
async def func_api_auth_login_email_password(*, request:Request):
   app_state=request.app.state
   obj_body=await app_state.func_request_param_read(request=request, mode="body", config=[("type","int",1,app_state.config_auth_type,None,None,"Enter Login Type, Example: 1, 2, 3"),("email","str",1,None,None,None,None),("password","str",1,None,None,["^\\S{8,32}$", "Password must be 8-32 characters and contain no spaces"],None)], strict=0)
...
async def func_api_auth_login_mobile_password(*, request:Request):
   app_state=request.app.state
   obj_body=await app_state.func_request_param_read(request=request, mode="body", config=[("type","int",1,app_state.config_auth_type,None,None,"Enter Login Type, Example: 1, 2, 3"),("mobile","str",1,None,None,None,None),("password","str",1,None,None,["^\\S{8,32}$", "Password must be 8-32 characters and contain no spaces"],None)], strict=0)
...
async def func_api_auth_login_email_otp(*, request:Request):
   app_state=request.app.state
   obj_body=await app_state.func_request_param_read(request=request, mode="body", config=[("type","int",1,app_state.config_auth_type,None,None,"Enter Login Type, Example: 1, 2, 3"),("email","str",1,None,None,None,None),("otp","int",1,None,None,None,"Enter the OTP sent to your Email")], strict=0)
...
async def func_api_auth_login_mobile_otp(*, request:Request):
   app_state=request.app.state
   obj_body=await app_state.func_request_param_read(request=request, mode="body", config=[("type","int",1,app_state.config_auth_type,None,None,"Enter Login Type, Example: 1, 2, 3"),("mobile","str",1,None,None,None,None),("otp","int",1,None,None,None,"Enter the OTP sent to your Mobile")], strict=0)
...
async def func_api_auth_login_google(*, request:Request):
   app_state=request.app.state
   obj_body=await app_state.func_request_param_read(request=request, mode="body", config=[("type","int",1,app_state.config_auth_type,None,None,"Enter Login Type, Example: 1, 2, 3"),("google_token","str",1,None,None,None,None)], strict=0)
