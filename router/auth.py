...
async def function_api_auth_signup_username_password(request:Request):
    ...
    param=await function_request_param_read(request,"body",[["type","int",1,None],["username","str",1,None],["password","str",1,None]])
...
async def function_api_auth_login_password_username(request:Request):
    param=await function_request_param_read(request,"body",[["type","int",1,None],["password","str",1,None],["username","str",1,None]])
...
async def function_api_auth_login_password_email(request:Request):
    param=await function_request_param_read(request,"body",[["type","int",1,None],["password","str",1,None],["email","str",1,None]])
...
async def function_api_auth_login_password_mobile(request:Request):
    param=await function_request_param_read(request,"body",[["type","int",1,None],["password","str",1,None],["mobile","str",1,None]])
...
async def function_api_auth_login_otp_email(request:Request):
    param=await function_request_param_read(request,"body",[["type","int",1,None],["otp","int",1,None],["email","str",1,None]])
    if param["type"] not in config_auth_type_list:raise Exception("type not allowed")
...
async def function_api_auth_login_otp_mobile(request:Request):
    param=await function_request_param_read(request,"body",[["type","int",1,None],["otp","int",1,None],["mobile","str",1,None]])
    if param["type"] not in config_auth_type_list:raise Exception("type not allowed")
...
async def function_api_auth_login_google(request:Request):
    param=await function_request_param_read(request,"body",[["type","int",1,None],["google_token","str",1,None]])
    if param["type"] not in config_auth_type_list:raise Exception("type not allowed")
