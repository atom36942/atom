...
async def func_api_root_postgres_runner(request:Request):
    param=await func_request_obj_read(request,"body",[["mode","str",1,None],["query","str",1,None]])
...
async def func_api_root_postgres_export(request:Request):
   param=await func_request_obj_read(request,"body",[["query","str",1,None]])
...
async def func_api_root_postgres_import(request:Request):
   param=await func_request_obj_read(request,"form",[["mode","str",1,None],["table","str",1,None],["file","file",1,[]]])
...
async def func_api_root_redis_import_create(request:Request):
   param=await func_request_obj_read(request,"form",[["table","str",1,None],["file","file",1,[]],["expiry_sec","int",0,None]])
   obj_list=await func_converter_file_api_obj_list(param["file"][-1])
...
async def func_api_root_mongodb_import_create(request:Request):
   param=await func_request_obj_read(request,"form",[["database","str",1,None],["table","str",1,None],["file","file",1,[]]])
   obj_list=await func_converter_file_api_obj_list(param["file"][-1])
...
async def func_api_root_s3_url_delete(request:Request):
    param=await func_request_obj_read(request,"body",[["url","list",1,[]]])
...
async def func_api_root_s3_bucket_ops(request:Request):
   param=await func_request_obj_read(request,"query",[["mode","str",1,None],["bucket","str",1,None]])
