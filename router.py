...
async def func_api_f5c4a2f6e328454e84732f36743916ee(request:Request):
   ...
   request.app.state.cache_postgres_schema,request.app.state.cache_postgres_column_datatype=await func_postgres_cache_reset(request.app.state.client_postgres_pool,request.app.state.func_postgres_schema_read)
   request.app.state.cache_users_role,request.app.state.cache_users_is_active=await func_users_cache_reset(request.app.state.client_postgres_pool,request.app.state.func_postgres_map_column,config_sql,request.app.state.cache_postgres_schema)
...
async def func_api_12df64ab29a4486ca541c0610ef30a16(request:Request):
   obj_query=await func_request_param_read("query",request,[("days","int",0,7)])
...
async def func_api_70db90992c9143cc9208268810bc8573(request:Request):
   obj_query=await func_request_param_read("query",request,[("is_unread","int",0,None),("order","str",0,None),("limit","int",0,None),("page","int",0,None)])
...
async def func_api_27632b8e47c144519a8cdc38262762db(request:Request):
   obj_query=await func_request_param_read("query",request,[("user_id","int",1,None),("order","str",0,None),("limit","int",0,None),("page","int",0,None)])
...
async def func_api_c0d03f1f0c3d41969cadb97483aeb75e(request:Request):
   obj_query=await func_request_param_read("query",request,[("table","str",1,None),("parent_table","str",1,None),("parent_column","str",1,None),("order","str",0,None),("limit","int",0,None),("page","int",0,None)])
...
async def func_api_ad13e1541fdf4aeda4702eba872afc41(request:Request):
   obj_query=await func_request_param_read("query",request,[("database","str",1,None),("table","str",1,None)])
   obj_body=await func_request_param_read("body",request,[])
...
async def func_api_c5119024bc5346d9a8ada54ee6dfdaed(request:Request):
   obj_query=await func_request_param_read("query",request,[("otp","int",1,None),("email","str",0,None),("mobile","str",0,None)])
...
async def func_api_ea356533d48f44bb9d7e79479fc43649(request:Request):
   obj_query=await func_request_param_read("query",request,[("url","str",1,None)])
   obj_body=await func_request_param_read("body",request,[])
   obj_list=obj_body["obj_list"] if "obj_list" in obj_body else [obj_body]
...
async def func_api_7031e803bbc544958a91c92a89187338(request:Request):
   obj_query=await func_request_param_read("query",request,[("bucket","str",1,None),("key","str",0,None)])
