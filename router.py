...
async def func_api_770160e847a341998b5b1c698e52e5c4(request:Request):
   ...
   token=await func_token_encode(user,config_key_jwt,config_token_expiry_sec,config_token_refresh_expiry_sec,config_token_key_list)
...
#mgh
@router.post("/mgh/amazon-invoice-send")
