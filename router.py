...
async def func_api_auth_signup_username_password(request:Request):
   obj_body=await func_request_param_read(request,"body",[("type","int",1,None,None,None),("username","str",1,None,None,None),("password","str",1,None,None,"^\\S{8,32}$")])
   user=await func_auth_signup_username_password(request.app.state.client_postgres_pool,obj_body["type"],obj_body["username"],obj_body["password"],config_is_signup=config_is_signup,config_auth_type=config_auth_type)
...
async def func_api_auth_signup_username_password_bigint(request:Request):
   obj_body=await func_request_param_read(request,"body",[("type","int",1,None,None,None),("username_bigint","int",1,None,None,None),("password_bigint","int",1,None,None,"^[0-9]{6,12}$")])
...
async def func_api_auth_login_password_username(request:Request):
   obj_body=await func_request_param_read(request,"body",[["type","int",1,None,None,None],["password","str",1,None,None,"^\\S{8,32}$"],["username","str",1,None,None,None]])
...
async def func_api_auth_login_password_username_bigint(request:Request):
   obj_body=await func_request_param_read(request,"body",[("type","int",1,None,None,None),("password_bigint","int",1,None,None,"^[0-9]{6,12}$"),("username_bigint","int",1,None,None,None)])
...
async def func_api_auth_login_password_email(request:Request):
   obj_body=await func_request_param_read(request,"body",[("type","int",1,None,None,None),("password","str",1,None,None,"^\\S{8,32}$"),("email","str",1,None,None,None)])
...
async def func_api_auth_login_password_mobile(request:Request):
   obj_body=await func_request_param_read(request,"body",[("type","int",1,None,None,None),("password","str",1,None,None,"^\\S{8,32}$"),("mobile","str",1,None,None,None)])
...
async def func_api_auth_login_otp_email(request:Request):
   obj_body=await func_request_param_read(request,"body",[("type","int",1,None,None,None),("email","str",1,None,None,None),("otp","int",1,None,None,None)])
...
async def func_api_auth_login_otp_mobile(request:Request):
   obj_body=await func_request_param_read(request,"body",[("type","int",1,None,None,None),("mobile","str",1,None,None,None),("otp","int",1,None,None,None)])
...
async def func_api_auth_login_google(request:Request):
   obj_body=await func_request_param_read(request,"body",[("type","int",1,None,None,None),("google_token","str",1,None,None,None)])
   user=await func_auth_login_google(request.app.state.client_postgres_pool,config_google_login_client_id,obj_body["type"],obj_body["google_token"],config_auth_type=config_auth_type)
   token=await func_token_encode(user,config_token_secret_key,config_token_expiry_sec,config_token_refresh_expiry_sec,config_token_key)
   return {"status":1,"message":{"user":user,"token":token}}
...
async def func_api_my_api_usage(request:Request):
   obj_query=await func_request_param_read(request,"query",[("days","int",1,None,None,None)])
...
async def func_api_my_account_delete(request:Request):
   obj_query=await func_request_param_read(request,"query",[("mode","str",1,["soft","hard"],None,None)])
...
async def func_api_my_message_received(request:Request):
   obj_query=await func_request_param_read(request,"query",[("mode","str",1,["all","unread","read"],None,None),("order","str",0,None,"id desc",None),("limit","int",0,None,100,None),("page","int",0,None,1,None)])
...
async def func_api_my_message_thread(request:Request):
   obj_query=await func_request_param_read(request,"query",[("user_id","int",1,None,None,None),("order","str",0,None,"id desc",None),("limit","int",0,None,100,None),("page","int",0,None,1,None)])
...
async def func_api_my_message_delete_single(request:Request):
   obj_query=await func_request_param_read(request,"query",[("id","int",1,None,None,None)])
...
async def func_api_my_message_delete_bulk(request:Request):
   obj_query=await func_request_param_read(request,"query",[("mode","str",1,["sent","received","all"],None,None)])
...
async def func_api_my_parent_read(request:Request):
   st=request.app.state
   obj_query=await func_request_param_read(request,"query",[("table","str",1,st.cache_postgres_schema_tables,None,None),("parent_table","str",1,st.cache_postgres_schema_tables,None,None),("parent_column","str",1,st.cache_postgres_schema_columns,None,None),("order","str",0,None,"id desc",None),("limit","int",0,None,100,None),("page","int",0,None,1,None)])
...
async def func_api_my_ids_delete(request:Request):
   st=request.app.state
   obj_body=await func_request_param_read(request,"body",[("table","str",1,st.cache_postgres_schema_tables,None,None),("ids","str",1,None,None,None)])
...
async def func_api_my_object_create(request:Request):
   st=request.app.state
   obj_query=await func_request_param_read(request,"query",[("table","str",1,st.cache_postgres_schema_tables,None,None),("mode","str",0,["now","buffer"],"now",None),("is_serialize","int",0,[0,1],0,None),("queue","str",0,None,None,None)])
   obj_body=await func_request_param_read(request,"body",[])
   return {"status":1,"message":await func_logic_obj_create("my",obj_query,obj_body,request.state.user.get("id"),st.config_table_create_my,st.config_table_create_public,st.config_column_blocked,st.client_postgres_pool,st.func_postgres_obj_serialize,st.config_table,st.func_producer_logic,st.client_celery_producer,st.client_kafka_producer,st.client_rabbitmq_producer,st.client_redis_producer,st.config_channel_allowed,st.func_celery_producer,st.func_kafka_producer,st.func_rabbitmq_producer,st.func_redis_producer,st.func_postgres_create,st.config_postgres_batch_limit)}

@router.put("/my/object-update")
async def func_api_my_object_update(request:Request):
   st=request.app.state
   obj_query=await func_request_param_read(request,"query",[("table","str",1,st.cache_postgres_schema_tables,None,None),("is_serialize","int",0,[0,1],0,None),("otp","int",0,None,None,None),("queue","str",0,None,None,None)])
   obj_body=await func_request_param_read(request,"body",[])
   return {"status":1,"message":await func_logic_obj_update("my",obj_query,obj_body,request.state.user.get("id"),st.config_column_blocked,st.config_column_single_update,st.client_postgres_pool,st.func_postgres_obj_serialize,st.func_producer_logic,st.client_celery_producer,st.client_kafka_producer,st.client_rabbitmq_producer,st.client_redis_producer,st.config_channel_allowed,st.func_celery_producer,st.func_kafka_producer,st.func_rabbitmq_producer,st.func_redis_producer,st.func_postgres_update,st.func_otp_verify,st.config_expiry_sec_otp,0,st.config_postgres_batch_limit)}

@router.get("/my/object-read")
async def func_api_my_object_read(request:Request):
   st=request.app.state
   obj_query=await func_request_param_read(request,"query",[("table","str",1,st.cache_postgres_schema_tables,None,None),("limit","int",0,None,100,None),("page","int",0,None,1,None),("order","str",0,None,"id desc",None),("column","str",0,None,"*",None),("creator_key","str",0,None,None,None),("action_key","str",0,None,None,None)])
...
async def func_api_my_object_create_mongodb(request:Request):
   obj_query=await func_request_param_read(request,"query",[("database","str",1,None,None,None),("table","str",1,None,None,None)])
   obj_body=await func_request_param_read(request,"body",[])
...
async def func_api_public_converter_number(request:Request):
   obj_query=await func_request_param_read(request,"query",[("datatype","str",1,["smallint","int","bigint"],None,None),("mode","str",1,["encode","decode"],None,None),("x","str",1,None,None,None)])
...
async def func_api_public_otp_verify_email(request:Request):
   obj_query=await func_request_param_read(request,"query",[("otp","int",1,None,None,None),("email","str",1,None,None,None)])
...
async def func_api_public_otp_verify_mobile(request:Request):
   obj_query=await func_request_param_read(request,"query",[("otp","int",1,None,None,None),("mobile","str",1,None,None,None)])
...
async def func_api_public_otp_send_email_ses(request:Request):
   st=request.app.state
   obj_data=await func_request_param_read(request,"query",[("sender","str",1,None,None,None),("email","str",1,None,None,None)])
...
async def func_api_public_otp_send_mobile_sns(request:Request):
   st=request.app.state
   obj_data=await func_request_param_read(request,"query",[("mobile","str",1,None,None,None)])
...
async def func_api_public_otp_send_mobile_sns_template(request:Request):
   st=request.app.state
   obj_data=await func_request_param_read(request,"body",[("mobile","str",1,None,None,None),("message","str",1,None,None,None),("template_id","str",1,None,None,None),("entity_id","str",1,None,None,None),("sender_id","str",1,None,None,None)])
   otp=await func_otp_generate(st.client_postgres_pool,None,obj_data["mobile"])
...
async def func_api_admin_postgres_runner(request:Request):
   obj_body=await func_request_param_read(request,"body",[("mode","str",1,["read","write"],None,None),("query","str",1,None,None,None)])
...
async def func_api_admin_postgres_export(request:Request):
   obj_body=await func_request_param_read(request,"body",[("query","str",1,None,None,None)])
...
async def func_api_admin_object_create(request:Request):
   ...
   obj_query=await func_request_param_read(request,"query",[("table","str",1,st.cache_postgres_schema_tables,None,None),("mode","str",0,["now","buffer"],"now",None),("is_serialize","int",0,[0,1],0,None),("queue","str",0,None,None,None)])
   obj_body=await func_request_param_read(request,"body",[])
   return {"status":1,"message":await func_logic_obj_create("admin",obj_query,obj_body,request.state.user.get("id"),st.config_table_create_my,st.config_table_create_public,st.config_column_blocked,st.client_postgres_pool,st.func_postgres_obj_serialize,st.config_table,st.func_producer_logic,st.client_celery_producer,st.client_kafka_producer,st.client_rabbitmq_producer,st.client_redis_producer,st.config_channel_allowed,st.func_celery_producer,st.func_kafka_producer,st.func_rabbitmq_producer,st.func_redis_producer,st.func_postgres_create,st.config_postgres_batch_limit)}
...
async def func_api_admin_object_update(request:Request):
   ...
   obj_query=await func_request_param_read(request,"query",[("table","str",1,st.cache_postgres_schema_tables,None,None),("is_serialize","int",0,[0,1],0,None),("otp","int",0,None,None,None),("queue","str",0,None,None,None)])
   obj_body=await func_request_param_read(request,"body",[])
   return {"status":1,"message":await func_logic_obj_update("admin",obj_query,obj_body,request.state.user.get("id"),st.config_column_blocked,st.config_column_single_update,st.client_postgres_pool,st.func_postgres_obj_serialize,st.func_producer_logic,st.client_celery_producer,st.client_kafka_producer,st.client_rabbitmq_producer,st.client_redis_producer,st.config_channel_allowed,st.func_celery_producer,st.func_kafka_producer,st.func_rabbitmq_producer,st.func_redis_producer,st.func_postgres_update,st.func_otp_verify,st.config_expiry_sec_otp,st.config_is_otp_users_update_admin,st.config_postgres_batch_limit)}
...
async def func_api_admin_redis_import_create(request:Request):
   st, count = request.app.state, 0
   obj_form=await func_request_param_read(request,"form",[("table","str",1,st.cache_postgres_schema_tables,None,None),("file","file",1,[],None,None),("expiry_sec","int",0,None,None,None)])
   async for obj_list in func_api_file_to_chunks(obj_form["file"][-1]):
...
async def func_api_admin_redis_import_delete(request:Request):
   st, count = request.app.state, 0
   obj_form=await func_request_param_read(request,"form",[("table","str",1,st.cache_postgres_schema_tables,None,None),("file","file",1,[],None,None)])
   async for obj_list in func_api_file_to_chunks(obj_form["file"][-1]):
      key_list=[f"""{obj_form["table"]}_{item["id"]}""" for item in obj_list]
...
async def func_api_admin_s3_bucket_ops(request:Request):
   obj_query=await func_request_param_read(request,"query",[("mode","str",1,["create","public","empty","delete"],None,None),("bucket","str",1,None,None,None)])
   st=request.app.state
...
async def func_api_admin_s3_url_delete(request:Request):
   st=request.app.state
   obj_body=await func_request_param_read(request,"body",[("url","list",1,[],None,None)])
